    ...
    public function IndexAction() {
        ...
        switch ($this->request['METHOD']) {
            ...
            case 'POST':
                ...
                if ($this->Valida()) {
                    $archivoPlantillaV = $_SESSION['theme'] . "/docs/plantillaMailVisitante.htm";                    
                    $archivoPlantillaW = $_SESSION['theme'] . "/docs/plantillaMailWebMaster.htm";                    
                    if ((file_exists($archivoPlantillaV)) and (file_exists($archivoPlantillaW))) {

                        $mailer = new Mail($this->varWeb['Pro']['mail']);
                        $envioOk = $this->enviaVisitante($mailer, $archivoPlantillaV);

                        if ($envioOk)
                            $envioOk = $this->enviaWebMaster($mailer, $archivoPlantillaW);
