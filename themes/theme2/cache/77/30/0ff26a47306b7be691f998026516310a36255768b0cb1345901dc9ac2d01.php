...
/* AvisoCookies/index.html.twig */
class __TwigTemplate_77300ff26a47306b7be691f998026516310a36255768b0cb1345901dc9ac2d01 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);

        $this->parent = $this->env->loadTemplate("_global/layoutLaptopPopup.html.twig");
    ...
    {
        // line 5
        echo "<div class=\"contenidoslegales\">

<h2>Política de cookies</h2><br /><br />

<b>TITULARIDAD DEL SITIO WEB</b><br /><br />

Dominio: ";
        // line 11
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["values"]) ? $context["values"] : null), "dominio"), "html", null, true);
        echo "<br /><br />
Razón Social: Juan Garde España<br /><br />
Domicilio Social: Avenida de Andalucía, 39, Local 2, 18230, Atarfe (Granada).<br /><br />
NIF: 26217004V<br /><br />
Teléfono: 958434799<br /><br />
E-mail: info@vendocamara.es<br /> 
...
<p>Juan Garde España (en adelante el prestador), responsable del sitio web, pone a disposición de los usuarios el presente documento con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSI-CE), así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso del mismo.</p>
...
<p>Esta página web NO utiliza \"cookies\", que son archivos de texto ubicados en su ordenador, para ayudar al website a analizar el uso que hacen los usuarios del sitio web. La información que genera la cookie acerca de su uso del website (incluyendo su dirección IP).</p>
<p>Puede usted rechazar el tratamiento de los datos o la información rechazando el uso de cookies mediante la selección de la configuración apropiada de su navegador, sin embargo, debe usted saber que si lo hace puede ser que no pueda usar la plena funcionalidad de este website.</p>
...
<b>LEY APLICABLE Y JURISDICCIÓN</b><br /><br />
...
";
    ...
    {
        return "AvisoCookies/index.html.twig";
    }
